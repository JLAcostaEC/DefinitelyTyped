...
/**
 * The global API export type for = ZingTouch. Contains a constructor for the
...
declare namespace ZingTouch {
  ...
  */
  class Region {
    ...
    bind(element: HTMLElement): Chainable;
    bindOnce(
      element: HTMLElement,
      gesture: RegionGestures,
      handler: (params: unknown) => unknown,
    ...
    bindOnce(element: HTMLElement): Chainable;
...
export type Chainable = {
  tap(handler: () => void, capture?: boolean): Chainable;
  swipe(handler: () => void, capture?: boolean): Chainable;
  pinch(handler: () => void, capture?: boolean): Chainable;
  expand(handler: () => void, capture?: boolean): Chainable;
  pan(handler: () => void, capture?: boolean): Chainable;
  rotate(handler: () => void, capture?: boolean): Chainable;
}
